        ...
        return {
            ...
            "merge_conflict": FeedbackTemplate(
                ...
                hints=[
                    ...
                    "After resolving, stage the files and commit the changes"
                ],
                examples={"resolve": "git add resolved_file.txt\ngit commit -m \"Resolve merge conflict\""}
            ),
            ...
            "rebase_conflict": FeedbackTemplate(
                ...
                examples={"continue": "git add resolved_file.txt\ngit rebase --continue"}
            ),
...
class ContextualHintGenerator:
    @staticmethod
    def generate_progressive_hints(error_type: str, skill_level: str, attempt_count: int) -> list[str]:
        base_hints = {
            "merge_conflict": [
