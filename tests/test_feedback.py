import unittest
from src.feedback import FeedbackManager, ErrorCategory
...
class TestFeedback(unittest.TestCase):
    ...
    def test_basic_feedback(self):
        feedback = self.feedback_manager.get_feedback("invalid_command", {"command": "git comit"})
    ...
    def test_progressive_feedback(self):
        ...
        self.assertIn("git init", feedback2.lower())

        # Third attempt - should show example
        feedback3 = self.feedback_manager.get_feedback("uninitialized_repo")
        self.assertIn("example", feedback3.lower())
    ...
    def test_reset_attempts(self):
        ...
        feedback = self.feedback_manager.get_feedback("invalid_command", {"command": "test"})
    ...
    def test_contextual_feedback(self):
        ...
        self.assertNotIn("hint", beginner_feedback.lower())  # No hints on first attempt
        ...
        self.assertNotIn("Use -m flag", advanced_feedback)  # Basic hints should be omitted
